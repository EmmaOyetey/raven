...
INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (1, 4, "Great organization, really helped me develop life skills through rugby.", "Sam Hoi", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (1, 5, "Dallaglio Rugby Works is amazing! The mentors are so supportive and encouraging.", "Billy New Johnson", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (2, 4, "ReachOut has made a positive impact on my life. My mentor has helped me improve my grades.", "Julie Doe", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (2, 5, "The volunteers at ReachOut are fantastic! They truly care about the kids.", "Hannah Gee", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (3, 3, "Career Ready has provided valuable career guidance, but could improve their resources.", "Daniel Doe", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (3, 4, "I'm grateful for the internship opportunities provided by Career Ready.", "Bill Smithers", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (4, 5, "Speakers for Schools has opened my eyes to various career paths. Highly recommended!", "Fred Frank", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (4, 4, "The talks organized by Speakers for Schools are insightful and inspiring.", "Dan Digger", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (5, 4, "The Brilliant Club's programs have helped me gain confidence in my academic abilities.", "George Smith", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (5, 3, "I wish The Brilliant Club provided more support outside of the classroom.", "Salma Mohammed Green", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (6, 5, "RISE Projects is doing incredible work in the community. Proud to be a part of it.", "Mohammed Mohammed", NOW());

INSERT INTO rating (organisation_id, rating, comment, name, created_at)
VALUES (6, 4, "The programs offered by RISE Projects have helped me develop leadership skills.", "Genka Bozkic", NOW());